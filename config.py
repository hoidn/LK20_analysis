...
detinfo_map = {'quad1': DetInfo('MecTargetChamber.0:Cspad.0', 
    '/Configure:0000/Run:0000/CalibCycle:0000/CsPad2x2::ElementV1/MecTargetChamber.0:Cspad2x2.1',
...
#           'r': 1041.4},
            ...
            #{'../masks/quad1_mask_10.27_shrunk3.npy'}, 0),
 'quad2': DetInfo('MecTargetChamber.0:Cspad.0',
    '/Configure:0000/Run:0000/CalibCycle:0000/CsPad2x2::ElementV1/MecTargetChamber.0:Cspad2x2.2',
     {'phi': -1.5899543,
           'x0': 654.165,
           'y0': 574.192,
           'alpha': 0.759423,
           'r': 970.13}, {'../masks/quad2_mask_10.11.npy'}, 1),
           #'r': 970.13}, {'../masks/quad2_mask_10.27_shrunk3.npy'}, 1),
 'allquads': DetInfo('MecTargetChamber.0:Cspad.0', 
    '/Configure:0000/Run:0000/CalibCycle:0000/CsPad::ElementV2/MecTargetChamber.0:Cspad.0',
     {'phi': None,
              'x0': None,
              'y0': None,
              'alpha': None,
 ...
 'si': DetInfo('MecTargetChamber.0:Opal1000.1',
     '/Configure:0000/Run:0000/CalibCycle:0000/Camera::FrameV1/MecTargetChamber.0:Opal1000.1',
     {}, {}, -1)}
...
# TODO: make this take a dataref (rather than a mere label)
def dataset_beam_intensity_diagnostic(dataset):
    """
    ...
    return gmd_scale_factor * si_integral_to_ev * mec.si_imarr_sum(dataset.evaluate('si').mean)
# TODO: make this take a dataref (rather than a mere label)

def beam_intensity_diagnostic(pattern):
    """
    return average beam energy in a dataset, evaluated based on si spectrometer spectrum.
    """
    gmd_scale_factor = 1.0
    si_integral_to_ev = 7.192326355322434e-11
    from dataccess import mec
    return gmd_scale_factor * si_integral_to_ev * mec.si_imarr_sum(pattern.dataset.evaluate('si').mean)
